...
public class BluntApWarhead extends AbstractApWarhead {
    public BluntApWarhead(Properties p_49795_) {
        super(p_49795_);
    }

    @Override
    public double getRaycastStep() { return 0.5; }

    @Override
    public double getRaycastPredictTime() { return 0.055; }

    //private static ShapeBuilder boundBuilder = ShapeBuilder.ofPrism(Direction.UP, 4);
    @Override
    public AABBd getLocalBound(BlockState state) {
        ...
        return new AABBd(-0.25, -0.25, -0.25, 1.25, 1.25, 1.25);
    }
