...
/*
public interface ICanCarryShip {
    public long getCarryingShipId();
    public default boolean isCarryingShip() { return getCarryingShipId() >= 0; }

    public boolean tryCarryInServer(long shipId, boolean sendToClient);
