...
public class AirDragData {

    //private ProjectileWrapper projectile;

    private Vector3d airDragCenterInShip;
    ...
    public AirDragData(ServerLevel level, ProjectileWrapper inProjectile) {
        airDragCenterInShip = calAirDragCenter(level, inProjectile.getShip(level));
    ...
    public void applyAirDrag(PhysShipImpl physShip) {
        ...
        Vector3d worldAirDragCenter = shipToWorld.transformPosition(airDragCenterInShip, new Vector3d());
