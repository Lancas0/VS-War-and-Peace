package com.lancas.vs_wap.ship.feature.pool;
...
import com.lancas.vs_wap.foundation.network.server2client.HideOrShowShipInClientS2C;
...
public class ShipPool extends SavedData {
    ...
    private static class HidingShip {
        ...
        public final HideType hideType;
    ...
    public ShipPool(ServerLevel inLevel) { level = inLevel; }
