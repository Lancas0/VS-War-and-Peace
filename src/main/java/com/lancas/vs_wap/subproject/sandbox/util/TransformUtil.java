...
public class TransformUtil {
    ...
    public static AABBd quickTransform(Matrix4dc transform, AABBdc aabbd, AABBd dest) {
        double w = transform.get(3, 3);
        ...
        Vector3d xa = col0.mul(aabbd.minX(), new Vector3d());
        Vector3d xb = col0.mul(aabbd.maxX(), new Vector3d());

        Vector3d ya = col1.mul(aabbd.minY(), new Vector3d());
        Vector3d yb = col1.mul(aabbd.maxY(), new Vector3d());

        Vector3d za = col2.mul(aabbd.minZ(), new Vector3d());
        Vector3d zb = col2.mul(aabbd.maxZ(), new Vector3d());
