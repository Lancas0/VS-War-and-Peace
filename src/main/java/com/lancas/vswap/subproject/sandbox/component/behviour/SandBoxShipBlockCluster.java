...
import com.lancas.vswap.subproject.sandbox.api.component.IDataReadableBehaviour;
import com.lancas.vswap.subproject.sandbox.api.component.IDataWritableBehaviour;
...
public class SandBoxShipBlockCluster extends BothSideBehaviour<BlockClusterData>
    implements IDataReadableBehaviour<BlockClusterData>, IDataWritableBehaviour<BlockClusterData> {
    ...
    public BlockState removeBlock(Vector3ic localPos) {
        ...
        if (oldState != null)  //if fail to remove(prestate is already null), don't invoke
            SandBoxEventMgr.onShipBlockReplaced.invokeAll(ship, localPos, oldState, Blocks.AIR.defaultBlockState());
    ...
    @Override
    public IBlockClusterDataWriter getDataWriter() { return data; }
