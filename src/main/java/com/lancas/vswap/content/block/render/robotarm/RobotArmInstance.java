package com.lancas.vswap.content.block.render.robotarm;
/*
...
public class RobotArmInstance extends SingleRotatingInstance<RobotArmBe> implements DynamicInstance {
    ...
    public RobotArmInstance(MaterialManager materialManager, ArmBlockEntity blockEntity) {
        ...
        this.claw = (ModelData)mat.getModel(AllPartialModels.ARM_CLAW_BASE, this.blockState).createInstance();
    ...
    private void animateArm(boolean rave) {
        ...
        int color;
        if (rave) {
            float renderTick = AnimationTickHolder.getRenderTime(((ArmBlockEntity)this.blockEntity).getLevel()) + (float)(((ArmBlockEntity)this.blockEntity).hashCode() % 64);
    ...
    protected Instancer<RotatingData> getModel() {
        return this.getRotatingMaterial().getModel(AllPartialModels.ARM_COG, ((ArmBlockEntity)this.blockEntity).getBlockState());
    }
