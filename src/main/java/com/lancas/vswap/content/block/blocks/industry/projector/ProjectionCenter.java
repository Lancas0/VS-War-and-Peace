...
public class ProjectionCenter extends BlockPlus implements IProjectBlock {
    @Override
    public List<IBlockAdder> getAdders() {
        return BlockPlus.addersIfAbsent(ProjectionCenter.class, () -> List.of(
    ...
    public ProjectionCenter(Properties p) {
        super(p);
    }
